...
export function KpiCard({
  ...
  return (
    <article
      className={`rounded-xl border border-slate-200 bg-white p-4 shadow-sm border-t-2 ${bar}`}
    >
    ...
    <div className="inline-flex rounded-lg border border-slate-200 bg-slate-50 p-0.5 text-xs font-semibold">
      <Link
        ...
        className={`rounded-md px-3 py-1.5 transition ${
          active === 'prtg' ? 'bg-blue-600 text-white shadow-sm' : 'text-slate-600 hover:text-slate-900'
        }`}
      >
        PRTG
      </Link>
      <Link
        ...
        className={`rounded-md px-3 py-1.5 transition ${
          active === 'cloudnet' ? 'bg-cyan-600 text-white shadow-sm' : 'text-slate-600 hover:text-slate-900'
        }`}
      >
        Cloudnet
      </Link>
